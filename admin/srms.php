...
class srms
{
	public $base_url = 'http://localhost/examination/system/';
	public $connect;
	public $query;
	public $statement;
	public $now;
	...
	{    
		...
		//live connection
		$this->connect = new PDO("mysql:host=us-cdbr-east-06.cleardb.net;dbname=heroku_c397dbc6db88858?", "b4515d52125d01", "2ab0d33f");
