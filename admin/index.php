...
<head>
    ...
    <meta name="description" content="This is a digital system that bridges a gap betwwen a school and parents by  keeping track of the students' academic performance on click of a button ">
    <meta name="author" content="Harry The Developer">

    <title>Online Student Performance Tracking System</title>
...
<body class="text-center">
    <main class="form-signin">
         <form method="post" id="login_form">
            <h1 class="h3 mb-3 fw-normal">LOGIN TO ACCESS THE SYSTEM</h1>
            <span id="error"></span>
